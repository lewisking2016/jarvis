...
- Tool arguments come ONLY from the principal's exact words in the latest message. Never substitute names, contacts or figures from memory, seeds or earlier conversations.
